...
def process_ws(ws):
        ...
        for num_clus in dict_user_clus[algo]:
            ...
            for user_id in dict_user_clus[algo][num_clus]:
                ...
                for ref in dict_user_clus[algo][num_clus][user_id]:
                    if min(dict_actual_20[algo][num_clus][ref], 5) != 0:
                        avg_user[user_id].append(dict_user_clus[algo][num_clus][user_id][ref] / min(dict_actual_20[algo][num_clus][ref], 5))
    ...
    return dict_actual_5, dict_user_clus, dict_actual_20, dict_how_many_classes

def merge_ws(dict_actual_51, dict_user_clus1, dict_actual_201, dict_how_many_classes1, dict_actual_52, dict_user_clus2, dict_actual_202, dict_how_many_classes2):
        ...
        for num_clus in dict_user_clus1[algo]:
            ...
            for user_id in dict_user_clus1[algo][num_clus]:
                ...
                for ref in dict_user_clus1[algo][num_clus][user_id]:
                    if min(dict_actual_201[algo][num_clus][ref], 5) != 0:
                        avg_user[user_id].append(dict_user_clus1[algo][num_clus][user_id][ref] / min(dict_actual_201[algo][num_clus][ref], 5))
                avg_avg_user[user_id] = np.average(avg_user[user_id])
            avg_avg_avg_user = list(avg_avg_user.values())
            v3 = np.round(np.average(avg_avg_avg_user) * 100, 2)
            avg_user = []
            for ref in dict_user_clus1[algo][num_clus][list(dict_user_clus1[algo][num_clus].keys())[0]]:
                if min(dict_actual_201[algo][num_clus][ref], 5) != 0:
                    avg_user.append(dict_actual_51[algo][num_clus][ref] / min(dict_actual_201[algo][num_clus][ref], 5))
            v32 = np.round(np.average(avg_user) * 100, 2)
            strtarget += " & $" + str(num_clus) + "$"
            ...
            for user_id in dict_user_clus2[algo][num_clus]:
                ...
                for ref in dict_user_clus2[algo][num_clus][user_id]:
                    if min(dict_actual_202[algo][num_clus][ref], 5) != 0:
                        avg_2user[user_id].append(dict_user_clus2[algo][num_clus][user_id][ref] / min(dict_actual_202[algo][num_clus][ref], 5))
            ...
            avg_2user = []
            for ref in dict_user_clus2[algo][num_clus][list(dict_user_clus2[algo][num_clus].keys())[0]]:
                if min(dict_actual_202[algo][num_clus][ref], 5) != 0:
                    avg_2user.append(dict_actual_52[algo][num_clus][ref] / min(dict_actual_202[algo][num_clus][ref], 5))
            v62 = np.round(np.average(avg_2user) * 100, 2)
            strtarget2 += " & $" + str(num_clus) + "$"
            strclus2 += " & $" + str(len(dict_how_many_classes2[algo][num_clus])) + "$"
            str6 += " & $" + str(v6) + "$"
            if "DBSCAN" == algo:
                print(num_clus, "&", len(dict_how_many_classes1[algo][num_clus]), "&",  v3, "&",  v32, "&", len(dict_how_many_classes2[algo][num_clus]), "&", v6, "&", v62, "\\\\ \\hline")
            else:
                print(num_clus, "&", v3, "&", v32, "&", v6, "&", v62, "\\\\ \\hline")
        print(strtarget, "\\\\ \\hline")
        if "DBSCAN" == algo:
            print(strclus, "\\\\ \\hline")
        print(str3, "\\\\ \\hline")
...
def merge_ws_algo(dict_actual_51, dict_user_clus1, dict_actual_201, dict_how_many_classes1, dict_actual_52, dict_user_clus2, dict_actual_202, dict_how_many_classes2):
    for num_clus in dict_user_clus1["KMeans"]:
        ...
        for algo in ["KMeans", "DBSCAN"]:
            ...
            v62 = np.round(np.average(avg_2user) * 100, 2)
            if "DBSCAN" == algo:
                printer += " & " + str(len(dict_how_many_classes1[algo][num_clus])) + " & " + str(v3) + " & " + str(v32) + " & " + str(len(dict_how_many_classes2[algo][num_clus])) + " & " + str(v6) + " & " + str(v62)
            else:                
                printer += str(num_clus) + " & " + str(v3) + " & " + str(v32) + " & " + str(v6) + " & " + str(v62)
        print(printer, "\\\\ \\hline")

dict_actual_51, dict_user_clus1, dict_actual_201, dict_how_many_classes1 = process_ws(10)
dict_actual_52, dict_user_clus2, dict_actual_202, dict_how_many_classes2 = process_ws(20)

merge_ws(dict_actual_51, dict_user_clus1, dict_actual_201, dict_how_many_classes1, dict_actual_52, dict_user_clus2, dict_actual_202, dict_how_many_classes2)
merge_ws_algo(dict_actual_51, dict_user_clus1, dict_actual_201, dict_how_many_classes1, dict_actual_52, dict_user_clus2, dict_actual_202, dict_how_many_classes2)