...
file_distance_json = open("count_me/all_percent_1/marker_all_percent_1_20.json", "r")
...
usable_ref = set()
for user_id_file in os.listdir("marked"):
    file_user_id = pd.read_csv("marked/" + user_id_file, sep = ";", index_col = False)
...
for user_id_file in os.listdir("marked"):
    user_id = user_id_file.replace(".csv", "")
    if user_id != "drNATK2FFHOwqpHZ0Y5fhqnQW9q1":
        continue
