    ...
    for xd2 in range(2):
        for yd1 in range(2):
            for yd2 in range(2):
                ...
                ord += 1
plt.savefig("class_illustrate_2.png", bbox_inches = "tight")
plt.close()
...
make_arrow(0, maxy, 0.1, angle = np.pi / 2)
make_arrow(maxx, 0, 0.1, angle = np.pi * 2)
plt.plot(long, lat, linewidth = 2)
plt.plot(long_new, lat_new, linewidth = 2)
plt.plot(long_new2, lat_new2, linewidth = 2)
plt.scatter(long_new2, lat_new2, c = "b", zorder = 2, linewidth = 3)
...
for num in infls_lat:
    plt.scatter(long_new2[num], lat_new2[num], c = "r", zorder = 2, linewidth = 3)
plt.savefig("rotate_illustrate_2.png", bbox_inches = "tight")
plt.close()