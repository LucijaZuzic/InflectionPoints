...
def process_ws(ws):
    ...
    print(stats.ttest_ind(binary_flat_actual_all, binary_flat_predicted_all, equal_var = False))
    print(stats.ttest_ind(euclidean_flat_actual_all, euclidean_flat_predicted_all, equal_var = False))
    print(stats.ttest_ind(selected_flat_actual_all, selected_flat_predicted_all, equal_var = False))
    ...
    print(stats.ttest_ind(binary_flat_users1, binary_flat_users2, equal_var = False))
    print(stats.ttest_ind(euclidean_flat_users1, euclidean_flat_users2, equal_var = False))
    print(stats.ttest_ind(selected_flat_users1, selected_flat_users2, equal_var = False)) 
