...
for algo in cluster_for_ref_10:
    ...
    for num_clus in cluster_for_ref_10[algo]:
        ...
        avg_yes_no(dict_how_many_classes10[algo][num_clus][minclus10], labels10) 
        avg_yes_no(dict_how_many_classes20[algo][num_clus][minclus20], labels20)