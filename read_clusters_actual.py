...
def process_ws(ws):
    ...
    for algo in dict_actual_20:
        ...
        for num_clus in dict_actual_20[algo]:
            avg_user = []
            for ref in dict_user_clus[algo][num_clus][list(dict_user_clus[algo][num_clus].keys())[0]]:
                if min(dict_actual_20[algo][num_clus][ref], 5) != 0:
                    avg_user.append(dict_actual_5[algo][num_clus][ref] / min(dict_actual_20[algo][num_clus][ref], 5))
            v3 = np.round(np.average(avg_user) * 100, 2)
...
def merge_ws(dict_actual_51, dict_user_clus1, dict_actual_201, dict_how_many_classes1, dict_actual_52, dict_user_clus2, dict_actual_202, dict_how_many_classes2):
    for algo in dict_user_clus1:
        ...
        for num_clus in dict_user_clus1[algo]:
            ...
            v6 = np.round(np.average(avg_2user) * 100, 2)
